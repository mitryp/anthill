...
String _$transactionControllerHash() =>
    r'39523481b5550a08ab55915a1297f81e9f16c4da';

/// See also [TransactionController].
@ProviderFor(TransactionController)
final transactionControllerProvider = AutoDisposeAsyncNotifierProvider<
    TransactionController, List<TransactionReadDto>>.internal(
...
typedef _$TransactionController
    = AutoDisposeAsyncNotifier<List<TransactionReadDto>>;
